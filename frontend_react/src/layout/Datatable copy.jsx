...
function Datatable( props ) {
  ...
  let { _currentMenuItem }  = useContext(SharedContext);  
  ...
  if (_currentMenuItem === 'itemMenuUsuarios')  
    ...
    <div className="CrudButtons">
        ...
        <div className="CrudButton" style={{ _paddingRight:'20px' }} >
          <div style={{width: '200px', height: '100%' }}>
              <input type='text' className='searchBox' placeholder='Pesquisar nome' />
          </div>
        ...
        <div className="CrudButton" style={{ paddingLeft:'20px', paddingRight:'20px', gap: '15px' }}    >
          ...
          <div><span>Adicionar Registro</span> </div>
        </div>
    </div>
